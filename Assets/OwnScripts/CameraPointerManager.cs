...
public class CameraPointerManager : MonoBehaviour
{
    ...
    private void PointerOnGaze(Vector3 hitPoint)
    {
        ...
        pointer.transform.parent.position = CalculatePointerPostion(transform.position, hitPoint, disPointerObject);
    }
    ...
    private Vector3 CalculatePointerPostion(Vector3 p0, Vector3 p1, float t)
    {
